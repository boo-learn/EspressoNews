...
@subscriptions_celery_app.task(name='subscription_service.tasks.subscribe_task')
...
@subscriptions_celery_app.task(name='subscription_service.tasks.unsubscribe_task')
