...
class SettingsHandlers(HandlersTools):
    ...
    async def change_periodicity_option(self, message: types.Message):
        await self.message_manager.send_message('change_option_periodicity')

    async def change_intonation_option(self, message: types.Message):
        await self.message_manager.send_message('change_option_intonation')

    async def change_role_option(self, message: types.Message):
        await self.message_manager.send_message('change_option_role')

    async def change_language_option(self, message: types.Message):
        await self.message_manager.send_message('change_option_language')
    ...
    async def success_change_language(self, message: types.Message):
        ...
        self.message_manager.set_language(language_option.code)
        await self.message_manager.send_message('settings_save_success')
        await self.message_manager.send_message('menu')
